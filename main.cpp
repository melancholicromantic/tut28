...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/GE/Projects/Content-main/quad.obj")) {
            return false;
        }
                       
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/GE/Projects/Content-main/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/GE/Projects/Content-main/normal_map.jpg");
